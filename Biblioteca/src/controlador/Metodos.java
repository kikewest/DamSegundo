...
public class Metodos {
	...
	private static Biblioteca crearBiblioteca() {
		...
		librosFiccionLiteraria.add(crearLibro("TRES ENIGMAS PARA LA ORGANIZACIÓN", "EDUARDO MENDOZA", 9788432242823L, "SEIX BARRAL", "24-01-2024", "408", "No vuelve con un detective chiflado, sino con nueve. No vuelve con un caso, sino con tres.Vuelve el mejor Eduardo Mendoza.", 20.80));
		librosFiccionLiteraria.add(crearLibro("EL BARRACON DE LAS MUJERES", "FERMINA CAÑAVERAS", 9788467071764L, "ESPASA", "10-01-2024", "504", "La novela que nos cuenta la dura realidad de las mujeres españolas obligadas a prostituirse en los campos de concentración.", 19.85));
		...
		librosFiccionLiteraria.add(crearLibro("PARÍS DESPERTABA TARDE", "EDUARDO MENDOZA", 9788432242823L, "SEIX BARRAL", "24-01-2024", "408", "No vuelve con un detective chiflado, sino con nueve. No vuelve con un caso, sino con tres.Vuelve el mejor Eduardo Mendoza.", 20.80));
		...
		CienciaFiccion.setNombre(CategoriasEnum.MisterioThriller);

		List<Libro> librosCienciaFiccion = new ArrayList<>();
		librosCienciaFiccion.add(crearLibro("El código Da Vinci", "Dan Brown", 9780307474278L, "Vintage", "18-03-2003", "592", "Un thriller que mezcla misterio, simbología y conspiraciones en torno a un oscuro secreto religioso.", 14.99));
		librosCienciaFiccion.add(crearLibro("La chica del tren", "Paula Hawkins", 9780735212169L, "Riverhead Books", "13-01-2015", "336", "Un emocionante thriller psicológico que sigue la vida de una mujer obsesionada con una pareja aparentemente perfecta.", 22.95));
		librosCienciaFiccion.add(crearLibro("El silencio de los corderos", "Thomas Harris", 9788497592252L, "DeBolsillo", "15-05-1988", "448", "Un clásico del thriller que presenta al famoso Hannibal Lecter, un brillante pero perturbador psiquiatra.", 18.00));
		librosCienciaFiccion.add(crearLibro("Perdida", "Gillian Flynn", 9788490328278L, "Penguin Books", "05-05-2012", "496", "Un thriller psicológico que sigue la desaparición de una mujer y los oscuros secretos que se revelan.", 20.50));
		librosCienciaFiccion.add(crearLibro("El juego de Gerald", "Stephen King", 9781501144202L, "Scribner", "01-05-1992", "512", "Un thriller psicológico que sigue los eventos aterradores después de un juego sexual que sale mal.", 25.99));

		CienciaFiccion.setLibros(librosCienciaFiccion);
		categorias.add(CienciaFiccion);

		Categoria Fantasia = new Categoria();
		Fantasia.setNombre(CategoriasEnum.MisterioThriller);
		...
		Romance.setNombre(CategoriasEnum.MisterioThriller);

		List<Libro> librosRomance= new ArrayList<>();
		librosRomance.add(crearLibro("El Señor de los Anillos: La Comunidad del Anillo", "J.R.R. Tolkien", 9788445000666L, "Minotauro", "29-07-1954", "464", "La primera entrega de la épica trilogía que sigue la odisea de Frodo para destruir el Anillo Único.", 28.99));
		librosRomance.add(crearLibro("Harry Potter y la piedra filosofal", "J.K. Rowling", 9788478884454L, "Salamandra", "26-06-1997", "256", "El inicio de la serie que narra las aventuras del joven mago Harry Potter y sus amigos en la escuela de magia Hogwarts.", 19.95));
		librosRomance.add(crearLibro("Canción de hielo y fuego: Juego de tronos", "George R.R. Martin", 9788496208908L, "Gigamesh", "06-08-1996", "800", "El primer libro de la serie que inspiró la popular serie de televisión Game of Thrones, ambientada en un mundo de fantasía épica.", 32.50));
		librosRomance.add(crearLibro("El nombre del viento", "Patrick Rothfuss", 9788499082479L, "Plaza & Janés", "01-04-2007", "880", "La primera entrega de la Crónica del Asesino de Reyes, que sigue la vida del músico y mago Kvothe.", 23.80));
		librosRomance.add(crearLibro("El Hobbit", "J.R.R. Tolkien", 9788445071407L, "Minotauro", "21-09-1937", "320", "La clásica novela que sigue las aventuras del hobbit Bilbo Bolsón en su búsqueda para recuperar el tesoro guardado por el dragón Smaug.", 15.75));
